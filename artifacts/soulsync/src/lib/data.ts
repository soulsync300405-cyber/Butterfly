...
export const COURSES = [
  { id: 1, title: "Mastering ADHD Focus", category: "ADHD", episodes: 6, duration: "2h 40m", featured: true, desc: "Learn the science of flow state. Break tasks down, manage cognitive load, and harness hyperfocus safely.", gradient: "from-blue-600 to-indigo-700", ep1: "The ADHD Brain: Your Superpower" },
  { id: 2, title: "OCD: Understanding Your Mind", category: "OCD", episodes: 4, duration: "1h 30m", featured: false, desc: "Demystify OCD patterns, understand intrusive thoughts, and build a compassionate relationship with your mind.", gradient: "from-purple-600 to-fuchsia-700", ep1: "What OCD Actually Is" },
  { id: 3, title: "Anxiety Decoded", category: "Anxiety", episodes: 8, duration: "3h 10m", featured: false, desc: "CBT fundamentals for anxiety. Reframe, regulate, and reclaim your calm with science-backed tools.", gradient: "from-amber-600 to-orange-700", ep1: "The Anxiety Loop" },
  { id: 4, title: "The Focus Formula", category: "Focus", episodes: 5, duration: "1h 55m", featured: false, desc: "Deep work strategies for students. Train your attention like a muscle with progressive exercises.", gradient: "from-teal-600 to-emerald-700", ep1: "Attention as a Skill" },
  { id: 5, title: "Emotional Intelligence 101", category: "EQ", episodes: 7, duration: "2h 45m", featured: false, desc: "Identify, understand, and manage emotions. Build empathy and stronger relationships.", gradient: "from-rose-600 to-pink-700", ep1: "What is EQ?" },
  { id: 6, title: "Sleep Science", category: "Wellness", episodes: 4, duration: "1h 20m", featured: false, desc: "Why you are tired all the time and what to do about it. Evidence-based sleep hygiene for students.", gradient: "from-violet-600 to-purple-700", ep1: "Your Circadian Rhythm" },
  { id: 7, title: "Stress to Strength", category: "Anxiety", episodes: 5, duration: "2h 00m", featured: false, desc: "Transform exam stress into focused energy. Practical techniques used by peak performers.", gradient: "from-cyan-600 to-sky-700", ep1: "Reframing Stress" },
  { id: 8, title: "Mindfulness Foundations", category: "Grounding", episodes: 6, duration: "2h 15m", featured: false, desc: "Build a daily mindfulness practice from scratch. No experience needed.", gradient: "from-green-600 to-emerald-700", ep1: "What Mindfulness Really Is" },
  { id: 9, title: "Confidence Architecture", category: "Focus", episodes: 5, duration: "1h 50m", featured: false, desc: "Build authentic self-confidence. Not fake it till you make it — actually make it.", gradient: "from-yellow-600 to-amber-700", ep1: "The Confidence Myth" },
  { id: 10, title: "Social Anxiety Toolkit", category: "Anxiety", episodes: 6, duration: "2h 25m", featured: false, desc: "Real strategies for social situations. From small talk to presentations.", gradient: "from-red-600 to-rose-700", ep1: "Social Anxiety vs Introversion" },
];
